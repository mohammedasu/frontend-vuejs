      ...
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          ...
          <div class="modal-header">
            <h5 class="modal-title text-left">Joining Request</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
            ...
            <form class="form" id="myform">
              <div class="scrollbarpan">
                <ul class="userlist-bordr">
                  <li
                    v-for="member in joining_requests"
                  ...
                  >
                    ...
                    <div>
                      ...
                      <template v-else>
                        <a
                          href="#"
                          @click.prevent="acceptRequest(member)"
...
export default {
  ...
  methods: {
    ...
    loadMoreMember() {
      this.fetchJoiningRequest(this.group_data_pass, "more");
    },
  },
};
</script>
