      ...
      <div class="modal-dialog">
        <div class="modal-content modal-lg">
          ...
          <div class="modal-header">
            <h5 class="modal-title text-left">Your connections</h5>
            <button
              type="button"
              class="close"
              data-dismiss="modal"
          ...
          <div class="modal-body">
            <form class="form" id="myform">
              <div class="scrollbarpan">
                <p class="nofound-sm" v-if="mutual_connections.length < 1">
                  No connection found
                </p>
                <ul class="userlist-bordr">
                  <li
                    v-for="member in mutual_connections"
                ...
                <button
                  v-if="mutual_next_page"
                  class="btnfill mx-auto d-flex"
                  @click.prevent="loadMoreMutualMember()"
                >
                  Load more
                </button>
              </div>
...
export default {
  ...
  methods: {
    ...
    loadMoreMutualMember() {
      this.fetchMutualConnections(this.group_data_pass, "more");
    },
  },
};
</script>
